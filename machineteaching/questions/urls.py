...
urlpatterns = [
    ...
    path('classes/manage/<int:onlineclass_id>', views.manage_class, name='manage_class'),
    path('delete_monitor/<int:onlineclass_id>/<int:monitor_id>', views.delete_monitor, name='delete_monitor'),
